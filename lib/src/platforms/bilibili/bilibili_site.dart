...
class BilibiliSite implements LiveSite {
  frb.LiveBilibiliExtractor? _extractor;
  frb_danmaku.LiveBilibiliDanmakuProvider? _danmakuProvider;
  ...
  Future<void> _ensureInit() async {
    if (_extractor == null) {
      await ensureFrbInit();
      _extractor = await frb.LiveBilibiliExtractor.newInstance();
      _danmakuProvider =
          await frb_danmaku.LiveBilibiliDanmakuProvider.newInstance();
    }
  }
  ...
  @override
  LiveDanmaku getDanmaku() => LiveBilibiliDanmaku(_danmakuProvider!);
  @override
