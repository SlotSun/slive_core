...
class DouyuSite implements LiveSite {
  frb.LiveDouyuExtractor? _extractor;
  frb_danmaku.LiveDouyuDanmakuProvider? _danmakuProvider;
  ...
  Future<void> _ensureInit() async {
    if (_extractor == null) {
      await ensureFrbInit();
      _extractor = await frb.LiveDouyuExtractor.newInstance();
      _danmakuProvider =
          await frb_danmaku.LiveDouyuDanmakuProvider.newInstance();
    }
  }
  ...
  @override
  LiveDanmaku getDanmaku() => LiveDouyuDanmaku(_danmakuProvider!);
  @override
