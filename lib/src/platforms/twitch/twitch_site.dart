...
class TwitchSite implements LiveSite {
  frb.LiveTwitchExtractor? _extractor;
  frb_danmaku.LiveTwitchDanmakuProvider? _danmakuProvider;
  ...
  Future<void> _ensureInit() async {
    if (_extractor == null) {
      await ensureFrbInit();
      _extractor = await frb.LiveTwitchExtractor.newInstance();
      _danmakuProvider =
          await frb_danmaku.LiveTwitchDanmakuProvider.newInstance();
    }
  }
  ...
  @override
  LiveDanmaku getDanmaku() => LiveTwitchDanmaku(_danmakuProvider!);
  @override
