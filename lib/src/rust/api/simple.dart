...
Future<void> testLog() => RustLib.instance.api.crateApiSimpleTestLog();

/// Detect platform from a live stream URL.
/// Returns the platform ID (e.g. "bilibili", "douyin", "douyu", "huya", "twitch") or None.
Future<String?> detectPlatform({required String url}) =>
    RustLib.instance.api.crateApiSimpleDetectPlatform(url: url);
